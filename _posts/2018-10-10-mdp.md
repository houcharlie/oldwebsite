...
This only contains the basic preliminaries.  These preliminaries will be updated as necessary as sort of a glossary, and are assumed to be the same for other blog posts on the topic.  I wanted to keep these blog posts short and to the point in order for each blog post to have a consistent and clear main idea.
